...
public class ScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new BLGGException("获取定时任务CronTrigger出现异常", e);
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            //构建job信息
            JobDetail jobDetail = JobBuilder.newJob(ScheduleJobUtil.class).withIdentity(getJobKey(scheduleJob.getJobId())).build();
            ...
            throw new BLGGException("创建定时任务失败", e);
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new BLGGException("更新定时任务失败", e);
        }
    }
    ...
    public static void run(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new BLGGException("立即执行定时任务失败", e);
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new BLGGException("暂停定时任务失败", e);
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new BLGGException("删除定时任务失败", e);
        }
    }
}
